...
const Invoice = () => {
  ...
  const addPayment = () => {
    ...
    calculatePaymentTotals([...payments, { amount: 0, date: '', method: 'PhonePe' }]);
  };
  ...
  const calculatePaymentTotals = (currentPayments) => {
    const totalPaid = currentPayments.reduce((acc, payment) => acc + (parseFloat(payment.amount) || 0), 0);
...
const generatePDF = async () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 space-y-6">
      ...
      {/* Payment Summary Section */}
      <div className="bg-white rounded-md p-6 shadow-sm border border-gray-200">
        <h2 className="text-xl font-semibold text-blue-500 mb-4">Payment Summary</h2>
